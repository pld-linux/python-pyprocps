...
Summary(pl):	Modu³ Pythona do zbierania informacji o procesach z linuksowego katalogu /proc
Name:		python-%{module}
Version:	0.2
Release:	1
License:	PSF
...
%description -l pl
Ten modu³ analizuje i obrazuje informacje z katalogu /proc w systemach
linuksowych.
